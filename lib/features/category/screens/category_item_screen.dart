...
class CategoryItemScreenState extends State<CategoryItemScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    bool showSubcategories = false; // Variável para controlar a exibição das subcategorias
        ...
        child: Scaffold(
          ...
          body: Center(child: SizedBox(
            ...
            child: Column(children: [
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () {
                        ...
                        // Exibir as subcategorias apenas se a categoria atual for a categoria pai
                        if (catController.subCategoryList![index].parentId == null) {
                          setState(() {
              ...
              // Exibir as subcategorias apenas se showSubcategories for true
              showSubcategories ? Center(
                child: Container(
                  width: Dimensions.webMaxWidth,
                  color: Theme.of(context).cardColor,
                  // Adicione aqui a lógica para exibir as subcategorias
                  // Você pode usar uma ListView.builder semelhante à lógica acima para exibir as subcategorias
                ),
              ) : const SizedBox(),
