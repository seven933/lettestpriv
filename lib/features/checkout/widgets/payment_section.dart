              ...
              child: Row(children: [
                Text(
                  checkoutController.paymentMethodIndex == 0 ? 'cash_on_delivery'.tr
                      ...
                      : (checkoutController.paymentMethodIndex == 3 || checkoutController.paymentMethodIndex == 6 ) ? 'credit_card'.tr 
                      : (checkoutController.paymentMethodIndex == 4 || checkoutController.paymentMethodIndex == 7) ? 'debit_card'.tr
                ...
                checkoutController.paymentMethodIndex == 3 || checkoutController.paymentMethodIndex == 6 || checkoutController.paymentMethodIndex == 4 || checkoutController.paymentMethodIndex == 7 ? Image.asset(
                  Images.mastercard,
                  width: 25,
                  height: 25,
                ) : const SizedBox(),
