  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        // Use SingleChildScrollView to avoid overflow and ensure scrolling
                  ...
                  : InkWell(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(height: 80), // Ensure spacing for widget positioning

                          // Add the CardSelectionWidget inside a SizedBox to control its height
                          checkoutController.paymentMethodIndex == 3 || checkoutController.paymentMethodIndex == 4
                            ? SizedBox(
                                height: 100, // Define an appropriate height
