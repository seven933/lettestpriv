      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            // - Widget com resumo dos preços
            !isDesktop ? pricingView(context: context, takeAway: takeAway) : const SizedBox(),
            const SizedBox(height: Dimensions.paddingSizeLarge),

            // - Widget que exibe quanto falta para atingir o valor minimo de entrega grátis
            (!takeAway && checkoutController.store!.minimumForFreeDelivery != null) ?
            FreeDeliveryWidget(
                minimumValue: checkoutController.store!.minimumForFreeDelivery!,
                currentValue: total,
            ) : const SizedBox(), 
            
            // - Mensagem que sobre os termos e condições do app
