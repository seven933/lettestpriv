...
import 'package:sixam_mart/features/checkout/widgets/free_delivery_widget.dart';
        ...
        child: CustomButton(
          ...
          onPressed: checkoutController.acceptTerms ? () {
            ...
            if(checkoutController.timeSlots == null || checkoutController.timeSlots!.isEmpty) {
              ...
              if(_cartList != null){ // verifica lista do carrinho de compras
            ...
            if(isGuestLogIn && checkoutController.guestAddress == null && checkoutController.orderType != 'take_away') {
              ...
              showCustomSnackBar('please_setup_your_delivery_address_first'.tr); // Pede para o guest configurar o endereço primeiro

            } else if(isGuestLogIn && checkoutController.orderType == 'take_away' && guestContactPersonNameController.text.isEmpty) {
           
              showCustomSnackBar('please_enter_contact_person_name'.tr); // pede contato do guest
           
            } else if(isGuestLogIn && checkoutController.orderType == 'take_away' && guestContactPersonNumberController.text.isEmpty) {
              
              showCustomSnackBar('please_enter_contact_person_number'.tr); // pede contato do guest
            }
            else if(isGuestLogIn && checkoutController.orderType == 'take_away' && guestEmailController.text.isEmpty) {
             
              showCustomSnackBar('please_enter_contact_person_email'.tr); // pede email  do guest
            
            } else if(!_isCashOnDeliveryActive! && !_isDigitalPaymentActive! && !_isWalletActive) {

              showCustomSnackBar('no_payment_method_is_enabled'.tr); // nenhuma método de pagamento ativo

            }else if(checkoutController.paymentMethodIndex == -1) { // método de pagamento ainda não selecionada
              ...
              if(ResponsiveHelper.isDesktop(context)){
                ...
                showModalBottomSheet( // mostra bottom sheet com os métodos de pagamento
            ...
            }else if (!isAvailable) { // avisa que um ou mais produtos não estão disponíveis
            ...
            }else if (!checkoutController.acceptTerms) { // mostra termos a serem aceitos antes do pedido
              ...
              if(widget.storeId == null){
                ...
                } else {*/ // chama o método de fazer o pedido
                ...
                //}
                checkoutController.placeOrderToCashOnDelivery(placeOrderBody);
