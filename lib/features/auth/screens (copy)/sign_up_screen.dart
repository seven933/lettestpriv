...
class SignUpScreenState extends State<SignUpScreen> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      !ResponsiveHelper.isDesktop(context) ? CustomTextField(
                        titleText: 'birthdate'.tr,
                        hintText: 'enter_your_birthdate'.tr,
  ...
  void _register(AuthController authController, String countryCode) async {
    ...
    String cpfFormatted = _cpfController.text.trim(); // CPF formatado
    String cpf = cpfFormatted.replaceAll(RegExp(r'\D'), ''); // Removendo formatação
    ...
    if (firstName.isEmpty) {
    ...
    } else if(cpf.isEmpty){ // Valida se o campo com o CPF está vazio
      ...
      SignUpBodyModel signUpBody = SignUpBodyModel(
        ...
        password: password, refCode: referCode, cpf: cpf,
      );
