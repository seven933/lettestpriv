...
class Store {
  ...
  Store.fromJson(Map<String, dynamic> json) {
    ...
    minimumForFreeDelivery = json['minimum_for_free_delivery'] != null ? json['minimum_for_free_delivery'].toDouble() : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['minimum_for_free_delivery'] = minimumForFreeDelivery;
