...
class StoreController extends GetxController implements GetxService {
  ...
  List<CardBrandModel>? _cardBrandList;
  List<CardBrandModel>? get cardBrandList => _cardBrandList;
  ...
  Future<void> getCardBrandList(int? storeId) async{

    _cardBrandList = null;

    List<CardBrandModel>? brandList = await storeServiceInterface.getCardBrandList(storeId);

    if(brandList != null){

      _cardBrandList = brandList;
