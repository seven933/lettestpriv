...
import 'package:sixam_mart/features/card/screens/account_card_list.dart';
...
class RouteHelper {
  ...
  static String getAccountCardsScreen() => accountCards;
  static String getAddCardAccountScreen() => addAccountCard;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      ...
      page: () => PixPaymentScreen(
        pixCode: Get.parameters['pix_code']!,
