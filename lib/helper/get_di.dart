...
import 'package:sixam_mart/features/card/domain/repositories/card_repository.dart';
import 'package:sixam_mart/features/card/domain/repositories/card_repository_interface.dart';
import 'package:sixam_mart/features/card/domain/services/card_service.dart';
...
import 'package:sixam_mart/features/pix/domain/services/pix_service.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  CardRepositoryInterface cardRepositoryInterface = CardRepository(sharedPreferences: Get.find());
  Get.lazyPut(() => cardRepositoryInterface);
  ...
  PixRepositoryInterface pixRepositoryInterface  = PixRepository(apiClient: Get.find(), sharedPreferences: Get.find());
  Get.lazyPut(() => pixRepositoryInterface);
  ...
  CardServiceInterface cardServiceInterface = CardService(cardRepositoryInterface: Get.find());
  Get.lazyPut(() => cardServiceInterface);
  ...
  Get.lazyPut(() => verificationServiceInterface);
    ...
    PixServiceInterface pixServiceInterface = PixService(pixRepositoryInterface: Get.find());
  Get.lazyPut(() => pixServiceInterface);
  ...
  Get.lazyPut(() => CardController(cardService: Get.find()));
